      ...
      <div className="prose prose-sm max-w-none space-y-6 sm:space-y-8 text-muted-foreground">
        <section>
          ...
          <p className="text-sm sm:text-base leading-relaxed">
            The Official App ("we", "our", or "us") is committed to protecting
            your privacy. This Privacy Policy explains how we collect, use,
            disclose, and safeguard your information when you use our sports
            operations platform.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-sm sm:text-base leading-relaxed">
            ...
            at{" "}
            <a
              href="mailto:privacy@the-official-app.com"
