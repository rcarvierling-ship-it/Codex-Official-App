      ...
      <div className="prose prose-sm max-w-none space-y-6 sm:space-y-8 text-muted-foreground">
        <section>
          ...
          <p className="text-sm sm:text-base leading-relaxed">
            By accessing or using The Official App ("the Service"), you agree to
        ...
        <section>
          ...
          <p className="text-sm sm:text-base leading-relaxed">
            Permission is granted to use the Service for the purpose of managing
            sports operations, event scheduling, and official assignments. This
        ...
        <section>
          ...
          <p className="text-sm sm:text-base leading-relaxed">
            In no event shall The Official App, its directors, employees, or
        ...
        <section>
          ...
          <p className="text-sm sm:text-base leading-relaxed">
            ...
            us at{" "}
            <a
              href="mailto:legal@the-official-app.com"
