  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-12 md:py-16">
      <header className="mb-8 sm:mb-12">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-semibold tracking-tight">Terms of Service</h1>
      ...
      <div className="prose prose-sm max-w-none space-y-6 sm:space-y-8 text-muted-foreground">
        <section>
          <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">Agreement to Terms</h2>
        ...
        <section>
          <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">Use License</h2>
          <p className="text-sm sm:text-base leading-relaxed">
        ...
        <section>
          <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">User Accounts</h2>
          <p className="text-sm sm:text-base leading-relaxed">
        ...
        <section>
          <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">Prohibited Uses</h2>
          <p className="text-sm sm:text-base leading-relaxed">You may not use the Service:</p>
        ...
        <section>
          <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-3 sm:mb-4">Limitation of Liability</h2>
          <p className="text-sm sm:text-base leading-relaxed">
