...
>>>>>>> 6c4bb1b05f097714713564a61fd6e75c753c40a5
      ...
      <Card className="bg-card/80">
        <CardHeader>
<<<<<<< HEAD
          <CardTitle className="text-lg sm:text-xl">{user?.name ?? email.split("@")[0]}</CardTitle>
          <p className="text-xs sm:text-sm text-muted-foreground">{email}</p>
        </CardHeader>
        <CardContent className="space-y-3 text-sm sm:text-base text-muted-foreground">
          <div>
            <p className="font-semibold text-foreground text-sm sm:text-base">Role</p>
...
>>>>>>> 6c4bb1b05f097714713564a61fd6e75c753c40a5
          ...
          {user?.schoolIds && user.schoolIds.length > 0 && (
            <div>
<<<<<<< HEAD
              <p className="font-semibold text-foreground text-sm sm:text-base">Schools</p>
              <p className="text-sm sm:text-base">{user.schoolIds.length} school(s) associated</p>
            </div>
          )}
